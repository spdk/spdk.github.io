...
• [Trello](https://www.trello.com/spdk/) is where we maintain our backlog and is a great place for design material for more complex patches. Once code has been merged, however, the documentation in the repository superseded any materials found on Trello (i.e., collateral found on Trello is not maintained once a feature is merged).
