...
## Aug 2018 44th International Conference on Very Large Data Bases
...
> At the OCP Summit 2018, Cavium, Microsemi and Marvell are demonstrated concurrent 100Gbps NVMe-oF RoCE and iWARP connectivity ..... showcases how storage IHVs can leverage PCIe P2P and SPDK technology ...

## Feb 6 2018 IBM Research Report
...
> This research team used SPDK to optimize the performance of gets and puts operation in the uDepot KV store. They showcased latency of 7.2 usecs and throughput of 6.17 million get operations/sec with Intel Optane SSDs and SPDK.
