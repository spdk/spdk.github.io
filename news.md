...
## 2018 VLDB Endowment 2150-8097/18/8
...
> This paper describes how PolarFS uses emerging techniques like RDMA, NVMe SSDs and SPDK to reduce the end-to-end latency: getting the latency of PolarFS close to a local file system on SSD.
...
> A research team at Microsoft used SPDK to optimize the I/O path in Deuterony (a Log-Structured data caching DB) and reduce the cost of I/O operations by a third.
