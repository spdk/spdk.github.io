...
The front end is composed of the network-facing driver. This is an entire blog post unto itself, but for now, the most relevant front end drivers are the ones supplied by RDMA NIC vendors or included in the Linux kernel. 
